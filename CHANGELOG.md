...
* Hide duplicate structure-browser cards when multiple world Actors reference the same structure rule and image, while preserving intentional image variants.
